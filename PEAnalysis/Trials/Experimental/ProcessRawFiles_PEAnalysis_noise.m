...
trackerExist = 0; %set 0 for SPE runs, and lab
   ...
   % run.path=['\\eosproject-smb\eos\project\p\picosec\testbeam\2023_August_h4\Pool2\Run' run.id '\'];
    %run.path=['\\eosproject-smb\eos\project\p\picosec\lab\Chiara\resistive\' run.id '\'];
%      run.path=['\\eosproject-smb\eos\project\p\picosec\lab\Chiara\antonija\' run.id '\'];
%     run.path=['\\eosproject-smb\eos\project\p\picosec\lab\Chiara\amplitudeVsTime\C103\' run.id '\'];

     %run.path=['"\\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\ResistiveMM-SPE-SlowPreamp\275A-500C-\' run.id '\'];
    % run.path=['\\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\ResistiveMM-SPE-SlowPreamp\275A-510C-\noise\'];
     %run.path=[' \\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\ResMM-SPE-SlowPream-2\275A-530C\noise\'];
     run.path=[' \\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\RMM-SPE-SlowPream-Elec-070624\10mVdiv\300A-520C\noise\'];
...
%      run.nfiles = find_fileNo(run.path);
    ...
    %store_folder = ['\\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\ResistiveMM-SPE-SlowPreamp\275A-510C-\Results\'];
    store_folder = ['\\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\RMM-SPE-SlowPream-Elec-070624\10mVdiv\300A-520C\Result\'];
...
%                   close all
            ...
            %eventXvec = eventXvec(1:end/8);
            %eventYvec = eventYvec(1:end/8);
