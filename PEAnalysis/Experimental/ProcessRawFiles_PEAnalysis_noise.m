...
%     run.path=['\\eosproject-smb\eos\project\p\picosec\lab\Chiara\amplitudeVsTime\C103\' run.id '\'];
    ...
    % run.path=['\\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\ResistiveMM-SPE-SlowPreamp\275A-510C-\noise\'];
     ...
     run.path=[' \\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\RMM-SPE-SlowPream-060624\10mVdiv\325A-500C\noise\'];
...
%      run.nfiles = find_fileNo(run.path);
    ...
    store_folder = ['\\eosproject-smb\eos\project\p\picosec\lab\ResistiveMM-SinglePad\RMM-SPE-SlowPream-060624\10mVdiv\325A-500C\Result\'];
