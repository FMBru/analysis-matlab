...
x0 = [1 1 0.2 3 b1 c1]; %3 parameters 3LEDs test ortec+3 noise  Deafult: [1 1 0.2 3 b1 c1]
...
for i=1:length(min_arr)
    ...
    options.Upper = [1000 150 0.08 100000 b1+b1*0.5 c1+c1*2.5];
