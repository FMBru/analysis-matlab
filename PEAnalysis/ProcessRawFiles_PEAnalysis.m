...
addpath '..\PEAnalysis\Functions';
addpath '..\CommonFunctions';


shouldPlotWaveform = false;
shouldSaveWaveformSamples = 3;
...
%% Tracker setup
trackerExist = 1; %set 0 for SPE runs with LED


%%config run

run.id = '062';
runInfoString = 'PE run CsI - A275V C420V';
...
run.path=['\\eosproject-smb\eos\project\p\picosec\testbeam\2025_July_h4\' run.oscilloscope '\Run' run.id '\'];
...
if trackerExist == 1
    ...
    %tracker.path = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2024_April_h4\tracker\reconstructed\ascii' run.id '.dat'];
    ...
    %dutColArray = [1 10 11; 2 13 14; 3 19 20; 4 22 23; 5 4 5; 6 24 25]; %[dID colXID colYID; ] -> July 2023 MM run
    dutColArray = [1 7 8; 2 10 11; 3 13 14; 4 16 17; 5 22 23; 6 25 26; 7 19 20]; %[dID colXID colYID; ] -> July 2025
