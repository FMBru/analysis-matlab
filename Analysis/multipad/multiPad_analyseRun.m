...
tic
load('\\eosproject-smb\eos\project\p\picosec\testbeam\2025_July_h4\Matlab\Run366-Pool2-Multipad double DLC pad 23 - 180 um - PC Ti 2p4 nm - Flushing - A275V C550V.mat');
pad23_table = table(eventIDArray(:), trackerX(:), trackerY(:), MM_maxy(:), MCP_maxy(:), e_peak_MM(:), time_diff_sigmoid(:), riseTime(:), 'VariableNames', {'eventID','X', 'Y', 'MM_amp1', 'MCP_amp1', 'e_peak_MM1', 'SAT1', 'riseTime1'});

%% gg
load('\\eosproject-smb\eos\project\p\picosec\testbeam\2025_July_h4\Matlab\Run366-Pool2-Multipad double DLC pad 33 - 180 um - PC Ti 2p4 nm - Flushing - A275V C550V.mat');
pad33_table = table(eventIDArray(:), trackerX(:), trackerY(:), MM_maxy(:), MCP_maxy(:), e_peak_MM(:), time_diff_sigmoid(:), riseTime(:), 'VariableNames', {'eventID','X', 'Y', 'MM_amp2', 'MCP_amp1', 'e_peak_MM2', 'SAT2', 'riseTime2'});

%% gg
load('\\eosproject-smb\eos\project\p\picosec\testbeam\2025_July_h4\Matlab\Run366-Pool3-Multipad double DLC pad 24 - 180 um - PC Ti 2p4 nm - Flushing - A275V C550V.mat');
pad24_table = table(eventIDArray(:), trackerX(:), trackerY(:), MM_maxy(:), MCP_maxy(:), e_peak_MM(:), time_diff_sigmoid(:), riseTime(:), 'VariableNames', {'eventID','X', 'Y', 'MM_amp3', 'MCP_amp3', 'e_peak_MM3', 'SAT3', 'riseTime3'});

load('\\eosproject-smb\eos\project\p\picosec\testbeam\2025_July_h4\Matlab\Run366-Pool3-Multipad double DLC pad 34 - 180 um - PC Ti 2p4 nm - Flushing - A275V C550V.mat');
pad34_table = table(eventIDArray(:), trackerX(:), trackerY(:), MM_maxy(:), MCP_maxy(:), e_peak_MM(:), time_diff_sigmoid(:), riseTime(:), 'VariableNames', {'eventID','X', 'Y', 'MM_amp4', 'MCP_amp3', 'e_peak_MM4', 'SAT4', 'riseTime4'});
toc
%% table merging 
tic
table_23_33 = outerjoin(pad23_table,pad33_table, 'Keys',{'eventID','X','Y', 'MCP_amp1'}, 'MergeKeys',true);
table_24_34 = outerjoin(pad24_table,pad34_table, 'Keys',{'eventID','X','Y', 'MCP_amp3'}, 'MergeKeys',true);

allpads_table = outerjoin(table_23_33,table_24_34, 'Keys',{'eventID','X','Y'}, 'MergeKeys',true);
toc
%% analysis
