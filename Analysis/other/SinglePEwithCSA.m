...
run.pathEOS=['\\eosproject-smb\eos\project\p\picosec\lab\Francesco\UV_LED_labtest\workshop\Data\Run' run.id '\'];
disp(run.pathEOS)
...
store_folder = ['\\eosproject-smb\eos\project\p\picosec\lab\Francesco\UV_LED_labtest\workshop\Results\Run' run.id '\AnalysisPlots\' runInfoString '\'];% add_str];
mkdir(store_folder);
