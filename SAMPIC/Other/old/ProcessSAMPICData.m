...
run.path=['\\eosproject-smb\eos\project\p\picosec\testbeam\2022_July_h4\SAMPIC\Run' run.id '\'];
...
store_folder = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2022_July_h4\Results\Run' run.id '-SAMPIC'];
mkdir(store_folder);

processingFolder = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2022_July_h4\SAMPIC\Processing\Run' run.id ];
