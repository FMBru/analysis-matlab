...
store_folder = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2022_July_h4\Results\Run' run.id '-' run.oscilloscope '\Combined'];
...
for padCounter = 1:length(activeChannels)
    ...
    twCorrectionFile = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2022_July_h4\Results\Run' run.id '-' run.oscilloscope '\CH' num2str(channelID) '-Pad' num2str(padID) '\twCorrection.txt'];
