function VisualiseMediumGranularity(channelsEnabled,dataArray,plotTitle,plotPath,plottingStringDesc,plottingString,minC,maxC,runID)
%close all
...
for r=1:19 %loop through pads
        ...
        channelID = getChannelForPadNumberMediumGranularity(padNumber,runID);
        padNumber;
        channelID;
