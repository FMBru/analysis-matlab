function VisualiseMediumGranularityEventWaveformsPosReco(padCenters,padIDsArray,dataArray,waveformsArray,plotTitle,plotPath,plottingStringDesc,plottingString,minC,maxC,trackerX,trackerY,recoX,recoY)
%close all
