...
save(['\\eosproject-smb\eos\project\p\picosec\testbeam\2022_July_h4\Results\Run' run.id '-' run.oscilloscope '\padResults.mat'], 'padResults'); % save interesting data for plots
