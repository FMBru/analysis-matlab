...
runIDsToAnalyse = ["269"];
loadVariables = false; %should load or plot only
...
if loadVariables
    ...
    for runPos = 1:length(runIDsToAnalyse)
        ...
        variablesFolder = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2024_June_h4\Results\Run' run.id '-SAMPIC\variables'];
        store_folderEvents = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2024_June_h4\Results\Run' run.id '-SAMPIC\events'];
