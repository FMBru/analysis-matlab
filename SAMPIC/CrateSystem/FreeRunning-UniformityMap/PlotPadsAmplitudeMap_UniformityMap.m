...
%padMaxYFitArray = [];
%padCountsArray = [];
%dutChannelArray = channelToAnalyse

%padIDsArray = zeros(10,10);
%padMeanArray = zeros(10,10);
%padCounts2DArray = zeros(10,10);
%padMeanFitArray = zeros(10,10);
...
VisualiseMultipad(padCHArray,padCountsArray,'Hitmap Multipad Picosec',[store_folder '\Run' run.id '_Hitmap.png'],'Hits','%d',0,0);

VisualiseMultipad(padCHArray,padMaxYArray,'Mean Amplitude Multipad Picosec',[store_folder '\Run' run.id '_MeanAmpMap.png'],'Mean','%.0fmV',0,0);

VisualiseMultipad(padCHArray,padMaxYFitArray,'Mean Amplitude from Fit Multipad Picosec',[store_folder '\Run' run.id '_MeanAmpFromFitMap.png'],'Mean','%.0fmV',0,0);
