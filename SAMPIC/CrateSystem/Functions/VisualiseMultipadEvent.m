function VisualiseMultipadEvent (channelsEnabled,dataArray,plotTitle,plotPath,plottingStringDesc,plottingString,minC,maxC,eventTrackerX,eventTrackerY,eventCalculatedX,eventCalculatedY)
dataArray;
%close all
minC;
maxC;
...
for r=1:10
    for c=1:10
        ...
        channelID = getChannelForPadNumber(padNumber);
        padNumber;
        channelID;
