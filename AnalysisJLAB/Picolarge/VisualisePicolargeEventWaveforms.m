function VisualisePicolargeEventWaveforms(padIDsArray,dataArray,waveformsArray,plotTitle,plotPath,plottingStringDesc,plottingString,minC,maxC,trackerX,trackerY)
%close all
...
waveformsArray
                for pos = 1:length(waveformsArray)
                       ...
                       subplot(5,5,subplotPosFree(1+waveformTemp.padID))
                        plot(waveformTemp.x,waveformTemp.y);
                        %xlim([0 0.1]);
