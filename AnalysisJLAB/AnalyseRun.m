...
%dataFilePath = append('/eos/project/p/picosec/testbeam/2024_April_h4/info/MatlabRunInfo');
...
%store_folder = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2024_April_h4\Results\Run' run.id '-' run.oscilloscope '-dut' opts_MM.chID '-ref' opts_MCP.chID '-' runInfoString];
store_folder = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2024_June_h4\ResultsJLab\Run' run.id '-' run.oscilloscope '-dut' opts_MM.chID '-ref' opts_MCP.chID '-' runInfoString];
mkdir(store_folder);

%resultsTablePath = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2024_April_h4\Results\resultsTable.txt'];
resultsTablePath = ['\\eosproject-smb\eos\project\p\picosec\testbeam\2024_June_h4\ResultsJLab\resultsTable.txt'];
...
evendIDOutliers = eventID(outliersMask);
